...
module.exports = ReadAllEventsBackward


function ReadAllEventsBackward(operationData) {
	if(!(this instanceof ReadAllEventsBackward)) {
		return new ReadAllEventsBackward(operationData)
	}
	OperationBase.call(this, operationData)


	Object.defineProperty(this, 'requestMessage', { value: 'ReadAllEventsBackward' })
	Object.defineProperty(this, 'requestType', { value: 'ReadAllEvents' })
	Object.defineProperty(this, 'responseMessage', { value: 'ReadAllEventsBackwardCompleted' })
...
util.inherits(ReadAllEventsBackward, OperationBase)

ReadAllEventsBackward.prototype.toRequestPayload = function() {
...
ReadAllEventsBackward.prototype.transformResponse = function(payload) {
...
ReadAllEventsBackward.prototype.toString = function() {
